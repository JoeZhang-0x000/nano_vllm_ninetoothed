...
kernel = ninetoothed.make(arrangement, application, (Tensor(2) for _ in range(3)), max_num_configs=MAX_NUM_CONFIG)
kernel_with_bias = ninetoothed.make(arrangement_with_bias, application_with_bias, (Tensor(2) for _ in range(4)), max_num_configs=MAX_NUM_CONFIG)
